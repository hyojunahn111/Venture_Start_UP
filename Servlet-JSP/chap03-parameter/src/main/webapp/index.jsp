...
<body>
    ...
    <a href="querystring?name=김상익&age=26&birthday=1999-09-09&gender=M&national=ko&hobbies=movie&hobbies=music&hobbies=sleep">쿼리스트링을 이용한 값 전달</a>

    <h3>POST 방식의 요청 (form 태그 이용)</h3>
    <h4></h4>
