...
public class Application {
    public static void main(String[] args) {
        ...
        * - session : HTTP 새션 당 하나의 인스턴스를 생성하고, 새션이 종료되면 폐기한다 ( 웹 어플리케이션 컨텍스트에만 해당 )
        ...
        * */
        ...
        ApplicationContext context = new AnnotationConfigApplicationContext(ContextConfiguaration.class);
