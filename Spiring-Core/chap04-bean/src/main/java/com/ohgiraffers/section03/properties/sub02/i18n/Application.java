...
public class Application {
    ...
    /*
    * [ i18n ]
    * = 소프트웨어 국제화(Internationalization에서 첫글자인 i와 마지막 글자인 n 사이 알파벳 갯수가 18개)
    ...
    * */
    public static void main(String[] args) {
        ...
        String error500MsgKR = context.getMessage("error.500", new Object[] {"김상익", new Date()}, Locale.KOREA);
