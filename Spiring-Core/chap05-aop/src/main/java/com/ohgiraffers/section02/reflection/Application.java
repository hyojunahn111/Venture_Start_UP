...
public class Application {
    ...
    /*
    * [ reflection ]
    * 컴파일된 자바 코드에서 역을 ㅗ클래스를 불러 method 및 field 정보를 구해오는 방법으로,
    * 반사, 투명이라는 의미를 가진다
    * 리플레션은 JVM에서 실행되는 애플리케이션의 런타임 동작을
    ...
    * 2. 캡슐화 저해 : private로 설정한 맴버에 접근 가능하므로 코드 기능이 저하되며 여러 문제를 발생시킬 수 있다
    *
    * [ Reflection이 사용되는 경우 ]
    * 1. IoC Container
    * 2. AOP
    ...
    * */
    ...
    public static void main(String[] args) {
        ...
        * 1) .class 문법을 이용하여 Class 타입의 인스턴스를 생성할 수 있다*/
        ...
        /*2) Object 클래스의 getClass() 메소드를 이용하면 Class 타입으로 리턴 받아 이용할 수 있다*/
        Class class2 = new Account().getClass();
        System.out.println("[class2]" + class2);

        try {
            /*3) class.forName() 메소드를 이용하여 런타임 시 로딩하고 해당 클래스 메타 정보를 Class타입으로 반환받을 수 있다*/
...
//        class class8 = d.getClass();
        ...
        System.out.println("[class 8]" + class8);
        ...
        try {
            toStringMethod.invoke((Account) constructors[0].newInstance("20", "110-123-123123", "0000", 10000));
        } catch (InstantiationException | IllegalAccessException | InvocationTargetException e) {
            e.printStackTrace();
        }
    }
