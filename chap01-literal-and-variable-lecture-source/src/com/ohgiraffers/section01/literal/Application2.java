...
public class Application2 {
    public static void main(String[] args) {
        ...
        * 1-1. 정수와 정수의 연산*/
        ...
        System.out.println(123 / 10);
        System.out.println(123 % 10); //모드(mod)연산 -> 두 수를 나눈 나머지
        ...
        /*2. 문자의 연산
        * 문자는 섯자로 안삭돤다. 따라서 숫자에 사용 가능한 연산이 전부 사용 가능하다 =*/
...
/*        System.out.println("hello" - "world");
        ...
        System.out.println("=====문자열과 다른 형태의 값=====");
        /*3-2-1 문자열과 정수의 연산*/
        ...
        /*이유는, 문자는 내부적으로 숫자 취급을 하기 때문에 결국 논리값과 연산과 동일한 의미이다*/
        ...
        /*이유는, 위에서 테스트를 해 본 문자열 합치기가 되는 원리와 동일하다*/
