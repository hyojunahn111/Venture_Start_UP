...
public class Application3 {
    public static void main(String[] args) {
        ...
        System.out.println(9 + 9 + "9");                        //'+' 연산 방향은 왼쪽에서 오른쪽이다. (숫자부터 합쳐짐)
        System.out.println(9 + "9" + 9);                        //왼쪽의 연산부터 수행하고 수행 결과를 오른쪽과 연산함
        System.out.println("9" + 9 + 9);

        /*바로 위에서 문자열 합치기 한 999 결과를 918로 변경(숫자 연산을 먼저 실행)하고 싶다면?*/
        /*상식 선에서 알고 있는 대로 괄호 기호를 이요해 숫자 연산을 묶어주게 되면 괄호 안에 있는 연산을 우선 수행한다*/
        System.out.println("9" + (9 + 9));

        /*문자열 합치기 응용*/
        /*10과 20의 사칙 연산 결과를 출력하세요*/
        System.out.println("=====10과 20의 사칙연산 괄과=====");
        ...
        System.out.println("=====10과20 사칙연산 결과 보기 좋게 출력=====");
