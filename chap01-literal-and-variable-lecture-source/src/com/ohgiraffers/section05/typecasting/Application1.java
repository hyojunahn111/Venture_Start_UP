...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 1-1-1 정수끼리의 자동형 변환
        * 점점 더 큰 자료형으로 데이터를 옮겨도 문제 없이 자동 형변환 처리 돤다*/
        byte bnum = 1;
        short snum = bnum;
        int inum = snum;
        long lnum = inum;
        ...
        /*정수는 실수로 변경할 때 소수점 자리수가 없어도 실수형태로 표현이 가능하다. 이 때 데이터 손실이 없기 때문에 자동형변환이 가능하다*/

        long eight = 888888888888888L;
...
//        long eight = 8;
        ...
        /*int로 hype이 정해지지 않은 리터럴 형태의 정수는 char 형 변수에 기록 가능하다*/
        char ch2 = 65;
