...
public class Appication2 {
    public static void main(String[] args) {
        ...
        * 논리 and 연산자 우선순위가 논리 or 연산자 우선순위보다 높다*/
        ...
        /*1. 1부터 1--사이의 값인지 확인*/
        /*1 <= 변수 <= 이렇게는 사용 못함 --> 변수 >= 1 && 변수 <= 100 이렇게 사용해야한다*/
        int num1 = 55;
        ...
        * 논리적으로 먼저 실행하는 내용을 괄호로 묶어주는게 좋다*/

        char ch5 = 'f';
        System.out.println("ch5가 영문자인지 확인 : " + ((ch5 >= 'A' && ch5 <= 'Z') || (ch5 >= 'a' && ch5 <= 'z')));
        System.out.println("ch5가 영문자인지 확인 : " + ((ch5 >= 65 && ch5 <= 90) || (ch5 >= 97 && ch5 <= 122)));

        char ch6 = 'F';
        System.out.println("ch6가 영문자인지 확인 : " + ((ch5 >= 'A' && ch6 <= 'Z') || (ch5 >= 'a' && ch6 <= 'z')));
        System.out.println("ch6가 영문자인지 확인 : " + ((ch5 >= 65 && ch6 <= 90) || (ch5 >= 97 && ch6 <= 122)));
