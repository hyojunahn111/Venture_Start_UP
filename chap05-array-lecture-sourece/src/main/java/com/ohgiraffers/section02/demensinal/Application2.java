...
public class Application2 {
    public static void main(String[] args) {
        ...
        /*그냥 변수 15개르르 사용하는 것과 똑같닥 ㅗ생각하면 된다
        * 하지만 배열은 [] 기호 안에 있는 숫자 대신 변수를 사용할 수 있다
        * 따라서 반복문 사용이 가능해진다
        * 위에서 값을 대입ㅎ고 출력한 것에 규칙을 찾아보고, 그 규칙대로 반복문을 이용해서 값을 대입 후 출력하는 구문으로 바꿔보자*/
        ...
        * 배열의 갯수만큼 반복적으로 접하며 값을 대입한다*/
        ...
        /*0부터 1까지 증가하며 마지막 인덱스까지 배열의 값을 하나씩 출력하고
