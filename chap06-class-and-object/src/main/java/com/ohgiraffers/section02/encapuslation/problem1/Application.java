package com.ohgiraffers.section02.encapuslation.problem1;
...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("monster name : " + monster2.name);
        System.out.println("monster2 hp " + monster2.hp);

        /*이처럼 검증되지 은 값을 넣을 때 문제가발생할 수 있다
        * 이를 해결하기 위해 Monster 클래스를 수정해보자*/
        ...
        /*음수 입력을 제한하는지 확인하도록 4번 몬스터 한마리 더 생성*/
        Monster monster4 = new Monster();
        monster4.name = "프랑켄";
        monster4.setHp(-1000);

        /*출력해보면 hpㄱ가 적어도 음수로 나오지는 않게 된다*/
