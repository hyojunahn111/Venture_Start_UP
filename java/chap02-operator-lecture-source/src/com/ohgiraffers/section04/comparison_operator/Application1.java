package com.ohgiraffers.section04.comparison_operator;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        * '==' : 왼쪽의 피연산자와 오른쪽의 피연산자가 같으면 true 다르면 false를 반환*/
        ...
        /*'>' : 왼쪽의 피연산자와 오른쪽의 피연산자가 크면 true 작으면 false를 반환*/
        ...
        System.out.println("inum1과 inum2가 같은지 비교 : " + (inum == inum2));
        System.out.println("inum1과 inum2가 같지 않은지 비교 : " + (inum != inum2));
        System.out.println("inum1과 inum2가 큰지 비교 : " + (inum > inum2));
        System.out.println("inum1과 inum2가 크거나 같은지 비교 : " + (inum >= inum2));
        System.out.println("inum1과 inum2가 작은지 비교 : " + (inum < inum2));
        System.out.println("inum1과 inum2가 작거나 같은지 비교 : " + (inum <= inum2));
...
//        System.out.println("bool1과 bool2가 작거나 큰지 비교 : " + (bool1 <= bool2));
