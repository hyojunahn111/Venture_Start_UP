...
public class Application3 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*조건식 두 개가 모두 만족해야 true를 반환하지만 아프에서 미리 false가 나오게 되면
        * 뒤의 조건을 확인할 필요 없이 false를 반환한다
        * 따라서 연산 횟수를 줄이기 위해서는 &&연산의 경우 앞에 false가 나올 가능성이 높은 조건을 작성하는 편이 좋다*/
        int num1 = 10;

        /*앞의 조건이 false로 강제화 해두고 && 뒤의 조건은 선치 증가로 값을 증가시킨 후 별 의미 없는 조건으로 만들어놓았다
        ...
        * 뒤의 조건을 확인할 필요 없이 true를 반환한다*/
        ...
        /*앞에 조건을 true로 강제화 해두고 || 뒤의 조건은 선치 증가로 값을 증가시킨 후 별 의미 없는 조건식으로 만들어 놓았다
