...
public class Application1 {
    ...
    public static void main(String[] args) {
         ...
         * 운영체제나 프로그래밍 언어가 제공하는 기술을 제어할 수 있도록 만든 인터페이스를 뜨한다
        ...
        /*1-2 import를 해서 사용*/
        /*클래스의 full-name말고 클래스명만 작성하려면 import를 배워야 한다고 배웠다
        * 하지만 Math 클래스는 근데 import하지 않아도 쓸 수 있다
        * java.lang 패키지에 속한 클래스이기 때문이다
        * system, String 또한 지금까지 따로 import 하지 않고 사용할 수 있었던 것은 두 클래스 또한 java.lang 패키지에 속하기 때문이다
        * 워낙 자주 사용하는 패키지이다 보니 import 하지 않고 사용할 수 있도록 해놓았다
        ...
        * */
        ...
        System.out.println("20과 30중 큰 것은 : " + Math.max(20, 30));

        /*수학적으로많이 사용하는 고정된 값들도 이미 Math 안에 정의된 것이 있다
        * 필드라는 것을 이용한 것인데 이 부분은 나중에 다루게 되니 걱정하지 말자*/
