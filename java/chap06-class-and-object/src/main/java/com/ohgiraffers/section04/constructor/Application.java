...
public class Application {
    public static void main(String[] args) {
        ...
        /*지금까지 우리가 객체를 생성했던 코드를 다시 한 번 살표 볼 것이다
        ...
        * 정상 동작하는거 확인하고 User 클래스의 기본생성자 주석 후 확인해보면 찾지 못한다는 에러 발생한다
        **/
        ...
        /*2. id, pwd, name을 매개변수로 전달 받는 생성자를 호출하여 인스턴스 생성 후 필드값 출력*/
        ...
        * 기본생성자로 인스턴스를 생성하면 현재 프로그램이 동작하는 운영체제 상의 날짜/시간 정보를 이용해 인스턴스를 생성한다*/
        ...
        /*위에 만든 user3과 지금 만든 user4는 동일한 필드값을 가지지만 hashCode는 다르다*/
