...
public class Product {
    ...
    /*1. 필드를초기화 하지 않으면 JVM이 정한 기본값으로 객체가 생성된다*/
...
//    private static String brand;
    ...
    /*3. 인스턴스 초기화 블럭*/
    {
        ...
        * 인스턴스 초기화블럭에서 대입한 값으로 덮어쓰게 되는 것이다*/
    ...
    static{
        ...
        * 정적 초기화 블럭은 클래스 로드 시에 동작ㅎ나다
        * 따라서 정적 초기화 블럭의 동작 시점ㅇ는 인스턴스가 아무것도 존재할 수 없기 때문에
...
//        price = 10000000;
    ...
    public String getInformation(){
        ...
        return "Produt [name=" + this.name + ", price" + this.price + ", brand=" + Product.brand + "]";
