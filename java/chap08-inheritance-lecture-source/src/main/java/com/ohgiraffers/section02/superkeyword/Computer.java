...
//        this(cpu, hdd, ram, operationSystem);
        ...
        * super()를 두 번 호출하는 것과 같이 때문에 허용되지 안는다
    ...
    /*setterㅘ getter는 부모 필드의 메소드에 대해서는 자신의 것 처럼 사용 가능하다
    * 따로 작성할 필요 없이 부모클래스에 작성한 것ㅇㄹ 사용할 수 있다
    * 따라서 자식클래스에 추가된 ㅣㄹ드에 대해선만 setter/getter를 작성하면 된다*/
    ...
    public String getInformation(){
        ...
        /*부모클래스에 작성한 getter를 이용해서 부모필드가 가진 값도 한 번에 문자열 합치기 한다
        * 부모가 가진 멤버는 super.과 this. 둘 다 사용이 가능하다
        * 하지만 코드의 의미를 명확하게 하기 위해 suer.을 사용하는 것이 좋다*/

//        return "Computer [" + "code=" + super.getCode() + ", brand=" + super.getBrand() + ", name=" + super.getName() + ", price : " + getPrice() + ", manufacturingDate : " + super.getManufacturingDate() + ", cpu : " + this.cpu + ", hdd : " + this.hdd + ", ram : " + this.ram + ", operationSystem : " + this.operationSystem + "]";
