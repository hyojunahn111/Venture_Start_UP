...
public class Application1 {
	...
	public static void main(String[] args) {
		...
		* 따라서 Rabbit은 rabbit타입이기도 하면서, Animal 타입이기도 하다
		* Tiger는 tiger 타입이면서 Anima 타입이기도 하다*/
...
//		Tiger t = new Animal();
		...
		* 런타임 당시에는 실체 객체가 가진 오버라이딩된 메소드로 바인딩이 바꾸어 동작하는 것을 의미한다*/
...
//		((Tiger)a1).bite();
		...
		/*레퍼런스변수가 참조하는 실제 인스턴스가 원하는 타입과 맞는지 비교하는 연산자 instatnceof*/
