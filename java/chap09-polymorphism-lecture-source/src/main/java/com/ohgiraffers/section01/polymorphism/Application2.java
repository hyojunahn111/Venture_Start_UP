...
public class Application2 {
	...
	public static void main(String[] args) {
		...
		/*다형성 적용하여 객체 배열을 만들어 인스턴스를 연속 처리할 수 있다*/
		...
		* 동물들 다 울어라! 이런 느낌이다*/
		...
		/*각 클래스별 고유한 메소드를동작시키게 하기 위해서는
		* down-casting을 명시적으로 해줘야 하는데
		* ClassCastException을 방지하기 위해서 instanceof 연산자를 이용해야한다*/

		for(int i = 0; i < animals.length; i++){

			/*동물들아 너가 만약 토끼면 점프를 뛰고, 호랑이면 울어라! 하는 느낌이다*/
