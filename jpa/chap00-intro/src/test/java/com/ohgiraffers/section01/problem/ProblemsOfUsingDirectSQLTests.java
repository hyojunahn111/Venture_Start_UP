...
//            menu.setMenuPrice(rset.getInt("MENU_PRICE"));
    ...
    void testAssociatedObject() throws SQLException {
        //given
        String query = "SELECT * FROM TBL_CODE, A.MENU_NAME, A.MENU_PRICE, B.CATEGORY_CODE, B.CATEGORY_NAME, ORDERABLE_STATUS " +
                       "FROM TBL_MENU A" +
        ...
        System.out.println(menuAndCategories.get(0).getCategory().getCategoryName());
    ...
    void testEqual() throws SQLException {
        ...
        Assertions.assertEquals(menu1.getMenuCode(), menu2.getMenuName());
